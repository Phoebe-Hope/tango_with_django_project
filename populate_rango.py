...
def populate():
    ...
    python_pages = [
        {'title': 'Official Python Tutorial',
         'url': 'http://docs.python.org/3/tutorial/', 'views':16},
    ...
    django_pages = [
        ...
        {'title':'Django Rocks',
         'url':'http://www.djangorocks.com/','views':7},
        {'title':'How to Tango with Django',
          'url':'http://www.tangowithdjango.com/','views':88}
    ]
    ...
    for cat, cat_data in cats.items():
        cat_obj = add_cat(name=cat, views=cat_data['views'], likes=cat_data['likes'])
        for page in cat_data['pages']:
            add_page(cat=cat_obj, title=page['title'], url=page['url'], views=page['views'])
